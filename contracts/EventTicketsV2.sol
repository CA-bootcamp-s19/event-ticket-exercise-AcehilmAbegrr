...
contract EventTicketsV2 {
    ...
    */
    modifier isOwner() {
        require(msg.sender == owner, 'caller of this function is restricted to the owner of it');
        _;
    }
    ...
    */
    function addEvent(string memory eventDescription, string memory URL, uint numTickets)
        public
        isOwner()
    ...
    */
        ...
        payable
    {
        ...
        require(msg.value >= numTickets*PRICE_TICKET, 'not enough funds to purchase ticket(s)');
        require(events[eventID].totalTickets >= numTickets, 'not enough tickets left for this event');
    ...
    */
    function getRefund(uint eventID)
        ...
        payable
    {
        require(events[eventID].buyers[msg.sender] > 0, 'user has no ticket(s) for this event');
